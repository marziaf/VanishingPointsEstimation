function [clusters] = tanimotoClustering(preference, edges) %%% TODO!!
    % tanimotoClustering: cluster edges from preference matrix
    ...
    for c = 1:numEdges
        for r = 1:numEdges
            if (r ~= c)
                distances(r, c) = tanimotoDistance( ...
